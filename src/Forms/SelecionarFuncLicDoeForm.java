 ...
 */
public class SelecionarFuncLicDoeForm extends javax.swing.JFrame {
    ...
    public SelecionarFuncLicDoeForm() throws IOException {
        initComponents();
        preencherTabela();
    }
    ...
    private void tf_nomePesqKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_nomePesqKeyReleased
        ...
        try {
            ...
            Logger.getLogger(SelecionarFuncLicDoeForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void tb_funcMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_funcMouseReleased
        ...
        if (tb_func.getSelectedRow() != -1) {
          ...
          NovaLicDoeForm dialog = new NovaLicDoeForm(this, true, func, this);            
