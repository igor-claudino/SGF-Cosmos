 ...
 */
public class SelecionarFuncAtestForm extends javax.swing.JFrame {
    ...
    public SelecionarFuncAtestForm() throws IOException {
        initComponents();
        preencherTabela();
    }
    ...
    private void tf_nomePesqKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_nomePesqKeyReleased
        ...
        try {
            ...
            Logger.getLogger(SelecionarFuncAtestForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void tb_funcMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_funcMouseReleased
        ...
        if (tb_func.getSelectedRow() != -1) {
          ...
          NovoAtestadoForm dialog = new NovoAtestadoForm(this, true, func, this);            
