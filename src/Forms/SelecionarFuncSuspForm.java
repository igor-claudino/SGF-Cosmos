 ...
 */
public class SelecionarFuncSuspForm extends javax.swing.JFrame {
    ...
    public SelecionarFuncSuspForm() throws IOException {
        initComponents();
        preencherTabela();
    }
    ...
    private void tf_nomePesqKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_nomePesqKeyReleased
        ...
        try {
            ...
            Logger.getLogger(SelecionarFuncSuspForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void tb_funcMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_funcMouseReleased
        ...
        if (tb_func.getSelectedRow() != -1) {
          ...
          NovaSuspensaoForm dialog = new NovaSuspensaoForm(this, true, func, this);            
